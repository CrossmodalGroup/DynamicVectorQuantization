...
from modules.clip_text_encoder.clip import clip
from modules.clip_text_encoder.clip import model as clip_model
from modules.clip_text_encoder.base_embedding import BaseEmbedding
