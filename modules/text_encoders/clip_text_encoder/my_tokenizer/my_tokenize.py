...
from modules.clip_text_encoder.clip.clip import tokenize
from modules.clip_text_encoder.my_tokenizer.base_codec import BaseCodec
from utils.utils import instantiate_from_config

class Tokenize(BaseCodec):
    def __init__(self, 
                 context_length:int = 77,
                 add_start_and_end:bool = True,
                 just_token = False,
                 with_mask:bool = True,
                 pad_value:int = 0,
