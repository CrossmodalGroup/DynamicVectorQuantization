...
class DualGrainVQModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0:
            ...
            # self.log("train_budget", log_dict_ae["train_budget_loss"], prog_bar=True, logger=True, on_step=True, on_epoch=True)
    ...
    def log_images(self, batch, **kwargs):
        ...
        log["grain_color"] = draw_dual_grain_256res_color(images=x.clone(), indices=grain_indices, scaler=0.7)
        return log
